        ...
        <div className="py-4 prose">
          ...
          <ul>
            ...
            <p className="text-sm mt-0 mb-0">
              Submit your guess of the opponent&apos;s secret number and the
              proof of the number of hits and blows for the opponent&apos;s
              guess. The proof generated by zkSNARK ensures your count is valid.
            </p>
